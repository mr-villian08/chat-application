...
$userId = $_SESSION['userLoggedIn']['id'];
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body" id="messages_area">
                        ...
                        if (!empty($chats)) {
                            foreach ($chats as $chat) {
                                // die;
                                if (isset($_SESSION["userLoggedIn"]) && $_SESSION['userLoggedIn']['id'] == $chat['user_id']) {
                                    $from = "Me";
                ...
                <form method="post" id="chat-form" data-parsley-errors-container="#validation-error">
                    <div class="input-group mb-3">
                        <textarea class="form-control" id="message" name="message" placeholder="Type Message Here" required></textarea>
